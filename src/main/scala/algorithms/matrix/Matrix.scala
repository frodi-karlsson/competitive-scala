...
trait MatrixTrait[T]:
    ...
    /**
      ...
      */
    def toGraph(f: (T, T) => Boolean, w: (T, T) => Double): WeightedGraph[(T, (Int, Int))]
    /**
      ...
      * @return A graph constructed from the matrix
      */
    def toGraphIndexLogic(f: ((Int, Int), (Int, Int)) => Boolean, w: (T, T) => Double): WeightedGraph[(T, (Int, Int))]
    /**
      ...
      * @return A graph constructed from the matrix
      */
    def toGraphIndexWeight(f: (T, T) => Boolean, w: ((Int, Int), (Int, Int)) => Double): WeightedGraph[(T, (Int, Int))]
    /**
      ...
      * @return A graph constructed from the matrix
      */
    def toGraphOnlyIndices(f: ((Int, Int), (Int, Int)) => Boolean, w: ((Int, Int), (Int, Int)) => Double): WeightedGraph[(T, (Int, Int))]
...
case class Matrix[T](override protected val vector: Vector[Vector[T]] = Vector.empty) extends MatrixTrait[T]:
    ...
    override def toGraph(f: (T, T) => Boolean, w: (T, T) => Double): WeightedGraph[(T, (Int, Int))] =
        val nodes = 
            vector
            .map(_.zipWithIndex)
            .zipWithIndex
        ...
        Graph(nodes, edges)
    override def toGraphIndexLogic(f: ((Int, Int), (Int, Int)) => Boolean, w: (T, T) => Double): WeightedGraph[(T, (Int, Int))] =
        val nodes = 
            vector
            .map(_.zipWithIndex)
            .zipWithIndex
        ...
        Graph(nodes, edges)
    override def toGraphIndexWeight(f: (T, T) => Boolean, w: ((Int, Int), (Int, Int)) => Double): WeightedGraph[(T, (Int, Int))] =
        val nodes = 
            vector
            .map(_.zipWithIndex)
            .zipWithIndex
    ...
    override def toGraphOnlyIndices(f: ((Int, Int), (Int, Int)) => Boolean, w: ((Int, Int), (Int, Int)) => Double): WeightedGraph[(T, (Int, Int))] =
        val nodes = 
            vector
            .map(_.zipWithIndex)
            .zipWithIndex
